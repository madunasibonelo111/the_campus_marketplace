    ...
    try {
      ...
      const { error: updateError } = await supabase
        ...
        .update({ 
          ...
          updated_at: new Date().toISOString(),
          ...(paymentStatus === 'completed' && { completed_at: new Date().toISOString() })
        })
      ...
      let booking = null;
      if (cashShortfall > 0) {
        booking = await createFacilityBooking(cashShortfall);
      }
      ...
      await sendPaymentConfirmation({ 
        success: true, 
        hasShortfall: cashShortfall > 0, 
        shortfallAmount: cashShortfall,
        booking: booking
      });
