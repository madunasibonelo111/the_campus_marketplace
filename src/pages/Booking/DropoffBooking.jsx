...
export default function DropoffBooking() {
      ...
      for (let i = 0; i < 7; i++) {
        ...
        while (currentTime < closeTime) {
          ...
          const { count, error: countError } = await supabase
            ...
            .eq('booking_date', currentTime.toISOString())
            .in('status', ['pending', 'confirmed']);
          
          const availableSpots = maxCapacity - (count || 0);
  ...
  const bookDropoffSlot = async () => {
    ...
    try {
      ...
      await supabase
        .from('transactions')
        .update({ status: 'pending_dropoff', updated_at: new Date().toISOString() })
          ...
          <div className="transaction-summary">
            ...
            <div className="summary-details">
              ...
              <div className="summary-info">
                ...
                <div className="summary-row">
                  <span>Status:</span>
                  <span className="status-badge success">Payment Completed ✓</span>
                </div>
              </div>
            </div>
          </div>
