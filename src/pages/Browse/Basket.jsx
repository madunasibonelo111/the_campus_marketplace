...
export default function Basket({ onViewListing }) {
  ...
  const [showBasket, setShowBasket] =
    useState(false);
  ...
  const [selectedTradeItem, setSelectedTradeItem] =
    useState(null);
              ...
              basket.map((i) => (
                ...
                >
                  ...
                  <div className="basket-item-info">
                    ...
                    <span className="basket-item-qty">
                      Qty: {i.quantity}
                    </span>
